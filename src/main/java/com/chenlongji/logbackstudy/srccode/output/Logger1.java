...
public final class Logger1 implements org.slf4j.Logger, LocationAwareLogger, AppenderAttachable<ILoggingEvent>, Serializable {
...
/**
    ...
    public static final String FQCN = Logger1.class.getName();
...
/**
    ...
    transient private Logger1 parent;
...
/**
    ...
    transient private List<Logger1> childrenList;
...
/**
    ...
    private int appendLoopOnAppenders(ILoggingEvent event) {
        if (aai != null) {
            // 核心代码: 获取logger的AppenderAttachableImpl下的所有appender执行输出
    ...
    Logger1(String name, Logger1 parent, LoggerContext loggerContext) {
        this.name = name;
        this.parent = parent;
    ...
    Logger1 getChildByName(final String childName) {
        if (childrenList == null) {
            return null;
        } else {
            int len = this.childrenList.size();
            for (int i = 0; i < len; i++) {
                final Logger1 childLogger_i = (Logger1) childrenList.get(i);
    ...
    public synchronized void setLevel(Level newLevel) {
        ...
        if (childrenList != null) {
            ...
            for (int i = 0; i < len; i++) {
                Logger1 child = (Logger1) childrenList.get(i);
...
/**
    ...
    Logger1 createChildByLastNamePart(final String lastPart) {
        ...
        if (this.isRootLogger()) {
            childLogger = new Logger1(lastPart, this, this.loggerContext);
        } else {
            childLogger = new Logger1(name + CoreConstants.DOT + lastPart, this, this.loggerContext);
        }
    ...
    void recursiveReset() {
        ...
        for (Logger1 childLogger : childrenList) {
...
/**
    ...
    Logger1 createChildByName(final String childName) {
        ...
        Logger1 childLogger;
        childLogger = new Logger1(childName, this, this.loggerContext);
        childrenList.add(childLogger);
        childLogger.effectiveLevelInt = this.effectiveLevelInt;
        return childLogger;
    }
