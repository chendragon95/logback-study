 ...
 * @author Ceki Gulcu
 */
public class ContextInitializer1 {

    final public static String AUTOCONFIG_FILE = "logback-bak.xml";
    final public static String TEST_AUTOCONFIG_FILE = "logback-test.xml";
    final public static String CONFIG_FILE_PROPERTY = "logback.configurationFile";

    final LoggerContext loggerContext;

    public ContextInitializer1(LoggerContext loggerContext) {
    ...
    public void configureByResource(URL url) throws JoranException {
        ...
        if (urlString.endsWith("xml")) {
            ...
            // 注: springboot项目有logback-spring.xml等配置文件时, 使用的是SpringBootJoranConfigurator
