...
public class MyStaticLoggerBinder implements LoggerFactoryBinder {
     ...
     */
    private static MyStaticLoggerBinder SINGLETON = new MyStaticLoggerBinder();
    ...
    public static MyStaticLoggerBinder getSingleton() {
        return SINGLETON;
    }
     ...
     */
    static void reset() {
        SINGLETON = new MyStaticLoggerBinder();
        SINGLETON.init();
    }
